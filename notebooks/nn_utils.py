    ...
    with torch.no_grad():
        ...
        for n_neighbors in n_neighbors_configs:
            ...
            for sample_idx in range(nn_indices.shape[0]):
                ...
                ant_valid_flag = False
                k = 0
                while k < len(sorting_idxs) and not ant_valid_flag:
                    ...
                    ant_valid_flag = check_ant_validity(ant_neighbor_og_repr, env_og_rel_repr) == 1
                    k += 1
